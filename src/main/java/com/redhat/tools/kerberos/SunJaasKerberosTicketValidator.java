...
public class SunJaasKerberosTicketValidator {
	...
	private static final Log LOG = LogFactory
			.getLog(SunJaasKerberosTicketValidator.class);
	...
	public String validateTicket(byte[] token) {
		...
		try {
			username = Subject.doAs(this.serviceSubject,
	...
	public void setProperties() throws Exception {
		...
		LoginConfig loginConfig = new LoginConfig(keytabURL.toExternalForm(),
				this.servicePrincipal, this.debug);
		Set<Principal> princ = new HashSet<Principal>(1);
		princ.add(new KerberosPrincipal(this.servicePrincipal));
		Subject sub = new Subject(false, princ, new HashSet<Object>(),
				new HashSet<Object>());
